<!-- Filename: Manifest_files / Display title: File manifesto -->

## Introduzione

Ogni estensione Joomla richiede un file manifesto. Viene utilizzato da Joomla per installare file nelle posizioni corrette e eseguire altri compiti durante l'installazione o la rimozione.

Si prega di fare riferimento alla sezione [Manifest Files](jdocmanual?article=docus/install-update/installation-manifest) della Documentazione per Programmatori di Joomla! per ulteriori informazioni.

Il seguente codice mostra il file manifest per il componente **Contatti** (com_contact) come esempio:
